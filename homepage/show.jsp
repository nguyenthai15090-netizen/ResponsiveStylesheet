<%-- 
    Document   : homepage
    Created on : Nov 6, 2025, 10:24:15 PM
    Author     : MinhPD
--%>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="resource/client/img/shop01.png" alt="">
                            </div>
                            <div class="shop-body">
                                <h3>Hot deal<br>Collection</h3>
                                <a href="${pageContext.request.contextPath}/store2?cate=sale" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /shop -->
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="resource/client/img/shop03.png" alt="">
                            </div>
                            <div class="shop-body">
                                <h3>New<br>Collection</h3>
                                <a href="${pageContext.request.contextPath}/store2?cate=new" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /shop -->
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="resource/client/img/shop02.png" alt="">
                            </div>
                            <div class="shop-body">
                                <h3>Top Selling<br>Collection</h3>
                                <a href="${pageContext.request.contextPath}/store2?cate=hot" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /shop -->
                                        ...
                                        <c:forEach var="product" items="${requestScope.newProducts}">                                       
                                            <div class="product">
                                                ...
                                                <form method="post" action="cart">
                                                    ...
                                                    <input type="hidden" name="returnUrl" value="<c:url value="/homepage"/>"> 
