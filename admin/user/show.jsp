                            ...
                            <div class="row">
                                <div class="col-12 mx-auto">
                                    <div class="d-flex justify-content-between">
                                        <h3>Table user</h3>
                                        <a href="/phoneshop/admin/user/create" class="btn btn-primary">Create new user</a>
                                    </div>
                                    <hr />
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.data}" var="user">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/phoneshop/admin/user/detail?id=${id}"
                                                           class="btn btn-success">View</a>
                                                        <a href="/phoneshop/admin/user/update?id=${id}"
                                                           class="btn btn-warning mx-2">Update</a>
                                                        <a href="/phoneshop/admin/user/delete?id=${id}"
