                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active"><a href="/phoneshop/admin/user">Users</a> </li>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12 mx-auto">
                                    ...
                                    <form method="post" action="delete"
                                        ...
                                        <button type="button" class="btn btn-success" onclick="window.location.href = '/phoneshop/admin/user';">Back</button>&nbsp;&nbsp;
