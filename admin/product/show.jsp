                            ...
                            <div class="row">
                                <div class="col-12 mx-auto">
                                    <div class="d-flex justify-content-between">
                                        <h3>Table product</h3>
                                        <a href="/phoneshop/admin/product/create" class="btn btn-primary">Create new
                                            product</a>
                                    </div>
                                    <hr />
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.data}" var="product">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/phoneshop/admin/product/detail?id=${id}"
                                                           class="btn btn-success">View</a>
                                                        <a href="/phoneshop/admin/product/update?id=${id}"
                                                           class="btn btn-warning mx-2">Update</a>
                                                        <a href="/phoneshop/admin/product/delete?id=${id}"
