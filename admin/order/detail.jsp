...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Dự án phoneshop" />
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="/phoneshop/admin/order">Orders</a></li>
                        ...
                        <div class="container mt-5">
                            <div class="row">
                                <div class="col-12 mx-auto">
                                                ...
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${o.status.statusId == 1}">
                                                            <form action="/phoneshop/admin/update" method="post">
                                    ...
                                    <a href="/phoneshop/admin/order" class="btn btn-success mt-3">Back</a>
