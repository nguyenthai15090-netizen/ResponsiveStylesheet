                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="/phoneshop/admin">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="/phoneshop/admin/product">Products</a></li>
                                ...
                                <div class="col-12 mx-auto">
                                    ...
                                    <div class="card" style="width: 60%">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">Chip Category: ${product.chipCategory}</li>
                                            <li class="list-group-item">Chip: ${product.chip}</li>
                                            <li class="list-group-item">RAM: ${product.ram}</li>
                                            <li class="list-group-item">Mem: ${product.mem}</li>
                                    ...
                                    <a href="/phoneshop/admin/product" class="btn btn-success mt-3">Back</a>
